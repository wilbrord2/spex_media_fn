  ...
  return (
    <div className="w-full h-screen relative flex items-center justify-center">
      ...
      <div className="relative flex-col gap-3 flex items-center justify-center bg-white/90 p-10 rounded-lg shadow-lg">
        ...
        <h2 className="text-center uppercase text-amber-800 font-bold text-3xl">
          Oops! Page Not Found
        </h2>
        ...
        <button
          ...
          className="hover:bg-amber-100 duration-300 transition text-slate-700 cursor-pointer px-5 py-2 rounded-full text-center border-amber-600 border"
        >
          Return Home
        </button>
      </div>
