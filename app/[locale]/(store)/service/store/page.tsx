    ...
    return (
      ...
      >
        ...
        <div className="absolute bottom-4 right-4  flex items-center gap-0">
          <button
            className="lg:hidden p-2 bg-primary hover:bg-primary/90 text-white rounded-lg transition-all cursor-pointer"
            onClick={(e) => {
              e.preventDefault();
              onAddToCart(book);
            }}
          ...
          <button
            className="hidden lg:flex items-center gap-2 px-3 py-2 bg-primary hover:bg-primary/90 text-white rounded-lg font-semibold text-xs transition-all cursor-pointer"
            onClick={(e) => {
              e.preventDefault();
              onAddToCart(book);
            }}
