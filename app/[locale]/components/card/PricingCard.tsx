...
const PricingCard = ({
  ...
  return (
    <div
      className={`"bg-white w-fit p-6  dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-shadow`}
    >
      ...
      <div className={` py-4 w-full`}>
        <button
          className={` ${
            id === "pro"
              ? "bg-[#1760bf] p-2 text-white"
              : "bg-[#1760bf] text-white p-3"
