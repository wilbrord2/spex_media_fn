...
export default function InfoCard({
  ...
  return (
    <div className="bg-white dark:bg-card rounded-2xl shadow-sm p-10 flex flex-col items-center   space-y-4 hover:scale-105 duration-300  hover:shadow-md transition-all">
      <div className="">
      ...
      {Array.isArray(content) ? (
        ...
        <p className="text-gray-600 text-center dark:text-gray-400 leading-relaxed">{content}</p>
      )}
    </div>
  );
}
