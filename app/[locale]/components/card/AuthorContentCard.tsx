      ...
      <Link href={url}>
        ...
        >
          <div className="overflow-hidden h-48 relative">
            ...
            />
            <div className="absolute top-3 left-3 bg-amber-700 text-xs text-white py-1 px-3 font-bold rounded-full shadow-lg">
              {category}
            </div>
          </div>

          <div className="p-5 flex flex-col gap-4">
            <h2 className="text-lg font-bold dark:text-gray-200 text-gray-900 group-hover:text-amber-700 transition-colors duration-300 line-clamp-2 min-h-14">
              {title}
            </h2>
            <div className="flex items-center justify-between mt-auto">
              <div className="flex flex-col gap-1 text-[10px] uppercase tracking-wider font-bold text-gray-500">
                ...
                <span className="flex items-center gap-1.5">
                  <CiCalendar className="text-amber-700 text-sm" />
              ...
              <button
                ...
                className="p-3 bg-amber-50 dark:bg-amber-950/30 text-amber-600 rounded-lg hover:bg-amber-600 hover:text-white transition-all duration-300 shadow-sm"
              >
                <FaTrashAlt size={16} />
              </button>
            </div>
            ...
            <div className="p-8 text-center">
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  disabled={isDeleting}
                  className="flex-1 py-1.5 px-2 bg-amber-600 text-white font-bold rounded-xl hover:bg-amber-700 transition disabled:opacity-50"
                >
